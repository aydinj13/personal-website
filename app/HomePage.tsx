...
import { ArrowRight, BookOpen, Coffee, Eye, Instagram, Mic, Star, Twitter, Youtube } from "lucide-react"
...
<section className="container mx-auto px-4 py-20">
  <div className="max-w-6xl mx-auto">
    <div className="flex justify-between items-center mb-12">
      ...
      <Button variant="outline" size="lg" className="hidden md:flex items-center">
...
<section className="bg-white py-20 text-center">
        <div className="container mx-auto px-4 max-w-2xl space-y-6">
          ...
          <p className="text-xl text-gray-600">
            If you find my content or services helpful, consider buying me a coffee. Your
            support helps me develop more applications.
          </p>
