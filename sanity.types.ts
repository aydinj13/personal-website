...
// Source: ./app/page.tsx
// Variable: query
// Query: {    "featured": *[_type == "featured"][0] {    title,    description,    url,    image,  },    "testimonials": *[_type == "testimonial"] | order(_createdAt desc),    "videos": *[_type == "video"] | order(_createdAt desc)[0...3],    "posts": *[_type == "post"] | order(createdAt desc)[0...3] {      _id,      title,      createdAt,      slug    }  }
